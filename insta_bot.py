...
class InstagramBot(SocialMediaBot):
    ...
    def like_post(self) -> None:
        ...
        try:
            ...
            #alternative xpath to click on heart if above doesn't work: "//button[@class='dCJp8 afkep coreSpriteHeartOpen _0mzm-']""
    ...
    block_user = block_user_toggle
    unblock_user = block_user_toggle
...
if __name__ == "__main__":
    try:        
        ...
        insta_bot.login(username,password,
                    ...
                    "//input[@name='username']",
                    "//input[@name='password']")
        stats = insta_bot.get_user_stats("https://www.instagram.com/clayclarks")
        print("Username: ",stats.username)
        print("Post count: ",stats.post_count)
        print("Follower count: ",stats.follower_count)
        print("Following count: ",stats.following_count)
        insta_bot.comment("hey clay im a bot", "https://www.instagram.com/p/BhViKnVhRW2/")
